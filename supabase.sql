...
drop policy if exists "Allow public applicant reads" on public.applicants;
drop policy if exists "Allow public applicant submissions" on public.applicants;
drop policy if exists "Allow public applicant updates" on public.applicants;
